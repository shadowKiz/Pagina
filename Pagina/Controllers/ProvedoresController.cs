...
namespace Pagina.Controllers
{
    ...
    {
        private provedoDBContext db = new provedoDBContext();
        ...
        public ActionResult Create([Bind(Include = "Id,Nombre,Tienda,url")] Provedores provedores)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Nombre,Tienda,url")] Provedores provedores)
        {
            if (ModelState.IsValid)
            {
